...
//altfp_add_sub CBX_AUTO_BLACKBOX="ALL" DENORMAL_SUPPORT="NO" DEVICE_FAMILY="Cyclone IV E" DIRECTION="ADD" OPTIMIZE="SPEED" PIPELINE=7 REDUCED_FUNCTIONALITY="NO" WIDTH_EXP=8 WIDTH_MAN=23 aclr clock dataa datab nan overflow result underflow zero
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  fp_adder_altfp_add_sub_e9m
	( 
	aclr,
	clock,
	dataa,
...
endmodule //fp_adder_altfp_add_sub_e9m
//VALID FILE
...
module fp_adder (
	...
	fp_adder_altfp_add_sub_e9m	fp_adder_altfp_add_sub_e9m_component (
				.aclr (aclr),
				.clock (clock),
				.dataa (dataa),
				.datab (datab),
